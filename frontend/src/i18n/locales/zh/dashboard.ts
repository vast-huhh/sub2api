export default {
  ...
  usage: {
    ...
    upstreamModel: '上游',
	  ...
	  modelVariant: '疑似版本变体',
	  modelMismatch: '模型不一致',
    copyCodexTurnState: '点击复制完整 X-Codex-Turn-State',
    codexTurnStateCopied: 'X-Codex-Turn-State 已复制',
    codexTurnStateLength: 'Turn State 长度（B）',
    codexTurnStateLengthHint: '客户端请求头 X-Codex-Turn-State 值的字节数；0 表示未携带或为空，- 表示未记录。WebSocket 按客户端握手请求头统计。',
