export default {
  ...
  usage: {
    ...
    upstreamModel: '上游',
	  ...
	  modelVariant: '疑似版本变体',
	  modelMismatch: '模型不一致',
    copyCodexTurnState: '点击复制完整上游响应头 X-Codex-Turn-State',
    codexTurnStateCopied: 'X-Codex-Turn-State 已复制',
    codexTurnStateLength: '响应 Turn State 长度（B）',
    codexTurnStateLengthHint: '上游响应头 X-Codex-Turn-State 值的字节数；0 表示响应未携带或为空，- 表示未记录响应值。WebSocket 按上游握手响应头统计。',
  ...
  redeem: {
    ...
    codeRule2: '兑换码可以增加余额、并发数、订阅或余额卡',
    ...
    balanceCardAssigned: '余额卡已分配',
    balanceCardPlan: '余额卡套餐',
