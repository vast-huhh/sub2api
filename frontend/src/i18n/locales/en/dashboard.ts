export default {
  ...
  usage: {
    ...
    copyCodexTurnState: 'Click to copy the full X-Codex-Turn-State',
    codexTurnStateCopied: 'X-Codex-Turn-State copied',
    codexTurnStateLength: 'Turn State Length (B)',
    codexTurnStateLengthHint: 'Byte length of the inbound X-Codex-Turn-State header value; 0 means absent or empty, - means not recorded. WebSocket records use the client handshake header.',
