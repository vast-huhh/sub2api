export default {
  ...
  usage: {
    ...
    copyCodexTurnState: 'Click to copy the full upstream response X-Codex-Turn-State',
    codexTurnStateCopied: 'X-Codex-Turn-State copied',
    codexTurnStateLength: 'Response Turn State Length (B)',
    codexTurnStateLengthHint: 'Byte length of the upstream response X-Codex-Turn-State header; 0 means absent or empty, - means the response value was not captured. WebSocket records use the upstream handshake response header.',
  ...
  redeem: {
    ...
    codeRule2: 'Codes may add balance, increase concurrency, grant subscriptions, or issue balance cards',
    ...
    balanceCardAssigned: 'Balance Card Assigned',
    balanceCardPlan: 'Balance Card Plan',
