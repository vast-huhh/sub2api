 ...
 * @param balanceCardPlanId - Balance card plan ID (required for balance_card type)
...
export async function generate(
  ...
  if (type === 'balance_card') {
    payload.balance_card_plan_id = balanceCardPlanId
  }
