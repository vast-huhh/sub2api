...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/balance-cards', label: t('nav.myBalanceCards'), icon: CreditCardIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/balance-cards', label: t('nav.balanceCards'), icon: CreditCardIcon, hideInSimpleMode: true },
