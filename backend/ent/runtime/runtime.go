...
func init() {
	...
	// redeemcodeDescBalanceCardPlanName is the schema descriptor for balance_card_plan_name field.
	redeemcodeDescBalanceCardPlanName := redeemcodeFields[12].Descriptor()
	// redeemcode.DefaultBalanceCardPlanName holds the default value on creation for the balance_card_plan_name field.
	redeemcode.DefaultBalanceCardPlanName = redeemcodeDescBalanceCardPlanName.Default.(string)
	// redeemcode.BalanceCardPlanNameValidator is a validator for the "balance_card_plan_name" field. It is called by the builders before save.
	redeemcode.BalanceCardPlanNameValidator = redeemcodeDescBalanceCardPlanName.Validators[0].(func(string) error)
	...
	// usagelogDescBalanceCardCost is the schema descriptor for balance_card_cost field.
	usagelogDescBalanceCardCost := usagelogFields[16].Descriptor()
	// usagelog.DefaultBalanceCardCost holds the default value on creation for the balance_card_cost field.
	usagelog.DefaultBalanceCardCost = usagelogDescBalanceCardCost.Default.(float64)
	// usagelogDescCashBalanceCost is the schema descriptor for cash_balance_cost field.
	usagelogDescCashBalanceCost := usagelogFields[17].Descriptor()
	// usagelog.DefaultCashBalanceCost holds the default value on creation for the cash_balance_cost field.
	usagelog.DefaultCashBalanceCost = usagelogDescCashBalanceCost.Default.(float64)
