...
var (
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "balance_card_plan_id", Type: field.TypeInt64, Nullable: true},
		{Name: "balance_card_plan_name", Type: field.TypeString, Size: 100, Default: ""},
		{Name: "group_id", Type: field.TypeInt64, Nullable: true},
	...
	RedeemCodesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "redeemcode_balance_card_plan_id",
				Unique:  false,
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "balance_card_id", Type: field.TypeInt64, Nullable: true},
		{Name: "balance_card_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "cash_balance_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
