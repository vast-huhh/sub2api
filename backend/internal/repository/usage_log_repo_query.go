...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		balanceCardID             sql.NullInt64
		balanceCardCost           float64
		cashBalanceCost           float64
		inputTokens               int
		outputTokens              int
		...
		codexTurnStateLength      sql.NullInt64
	...
	log := &service.UsageLog{
		...
		BalanceCardCost:           balanceCardCost,
		CashBalanceCost:           cashBalanceCost,
	...
	if balanceCardID.Valid {
		value := balanceCardID.Int64
		log.BalanceCardID = &value
	}
	if durationMs.Valid {
	...
	if codexTurnStateLength.Valid {
		value := int(codexTurnStateLength.Int64)
		log.CodexTurnStateLength = &value
	}
