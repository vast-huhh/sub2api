...
func redeemCodeFromServiceBase(rc *service.RedeemCode) RedeemCode {
	out := RedeemCode{
		...
		BalanceCardPlanID:   rc.BalanceCardPlanID,
		BalanceCardPlanName: rc.BalanceCardPlanName,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		BalanceCardID:             l.BalanceCardID,
		BalanceCardCost:           l.BalanceCardCost,
		CashBalanceCost:           l.CashBalanceCost,
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	return &AdminUsageLog{
		...
		CodexTurnStateLength:    l.CodexTurnStateLength,
