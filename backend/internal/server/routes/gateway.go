...
func RegisterGatewayRoutes(
	...
	usageRequestHeaders := middleware.UsageRequestHeaders()
	...
	gateway.Use(clientRequestID, usageRequestHeaders)
	...
	gemini.Use(clientRequestID, usageRequestHeaders)
	...
	rootRoute := func(method, path string, limit gin.HandlerFunc, handler gin.HandlerFunc) {
		r.Handle(method, path, limit, clientRequestID, usageRequestHeaders, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, compositeTarget, requireGroupAnthropic, handler)
	}
	...
	codexDirect.Use(bodyLimit, clientRequestID, usageRequestHeaders, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, compositeTarget, requireGroupAnthropic)
	{
	...
	antigravityV1.Use(clientRequestID, usageRequestHeaders)
	...
	antigravityV1Beta.Use(clientRequestID, usageRequestHeaders)
